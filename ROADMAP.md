...
| 17 | ✅ **Fait (HOS-234 → HOS-236)** — 10 routes servies, console de supervision, détail de run, trace réelle, 10 Control Rooms, **vérifié en navigateur** | trois défauts trouvés : routes posées sur un routeur non monté, `success_rate: 100` sur zéro tâche, et un `?? 100` côté Cockpit. **Hors périmètre assumé** : les analytiques, absentes des critères de sortie | 54 gardes |
