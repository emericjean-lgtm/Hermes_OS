...
| 16 | 🟨 **Partiel (HOS-232)** — version, sauvegarde, séquence, retour arrière, auto-vérification réelle | ⚠️ **défaut trouvé** : `preserve_set()` ne couvrait pas `checkpoints` — une mise à jour aurait effacé le seul moyen de l'annuler. **Reste à faire** : le remplacement du code, qui demande un canal de distribution | 26 gardes |
