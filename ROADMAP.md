...
| 17 | 🟨 **Partiel (HOS-234)** — 8 routes `GET`, modèle de lecture à cinq sections, version réelle | mesuré : **zéro route** n'exposait les jalons 5→16. Le frontend, lui, ne fabriquait déjà plus rien. **Reste** : les vues React (Control Rooms, trace vivante, analytiques), qui n'étaient pas constructibles avant | 21 gardes |
